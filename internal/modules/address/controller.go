...
func (c *Controller) List(ctx *fiber.Ctx) error {
	...
	addrs, total, err := c.service.List(ctx.Context(), req)
	if err != nil {
		return err
	}
	resp := make([]Response, len(addrs))
	for i, a := range addrs {
		resp[i] = ToResponse(a)
	}
...
func (c *Controller) GetByID(ctx *fiber.Ctx) error {
	...
	a, err := c.service.GetByID(ctx.Context(), id)
	if err != nil {
		return err
	}
	return ctx.JSON(ToResponse(*a))
}
...
func (c *Controller) Create(ctx *fiber.Ctx) error {
	...
	a, err := c.service.Create(ctx.Context(), req)
	if err != nil {
		return err
	}
	return ctx.Status(fiber.StatusCreated).JSON(ToResponse(*a))
}
...
func (c *Controller) Update(ctx *fiber.Ctx) error {
	...
	a, err := c.service.Update(ctx.Context(), id, req)
	if err != nil {
		return err
	}
	return ctx.JSON(ToResponse(*a))
